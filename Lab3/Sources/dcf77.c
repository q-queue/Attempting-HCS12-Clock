...
static char dcf77Month=1, dcf77Day=1, dcf77Hour=0, dcf77Minute=0, dcf77Weekday = 7;       //dcf77 Date and time as integer values

static int dcf77Year=2017;

static char DC77_UTC_TIME_ZONE = +2;    // CEST // TODO: adjust later from signal
...
{   DCF77EVENT event = NODCF77EVENT;
    ...
    static char last_sample = 1;   // start high?
...
static void decode_clock_info(DCF77EVENT event)
{
    ...
    #define BIT_SKIP 19     // TODO: less skipping

    if (received_bit < BIT_SKIP) return;
